namespace MaxNetworkPathFindingAlgorithm
{
    partial class FormHelper
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox5.Size = new System.Drawing.Size(233, 106);
            this.textBox5.TabIndex = 4;
            this.textBox5.TabStop = false;
            this.textBox5.Text = "Для перемещения вершин используйте инструмент \"По умолчанию\". А также, чтобы изме" +
    "нить номер вершины нужно нажать правой кнопкой мыши на нее.";
            // 
            // textBox4
            // 
            ...
            this.textBox2.Text = "Для удаления вершины или дуги воспользуйтесь инструментом \"Удалить объект\". Чтобы" +
    " удалить дугу, нужно нажать на стрелочку той дуги, которую хотите удалить.";
            // 
            // textBox1
            // 
